...
from test_data.prompts import ATTACHMENT

log = logging.getLogger(__name__)


# Verifies mixed file attachments show a warning and the task still completes.
def test_task_attachments(page, go_to_home_page, task_page):
    ...
    go_to_home_page.enter_task(task=ATTACHMENT)
