...
from test_data.prompts import FOLLOW_UP_ANDROID_ACTION

log = logging.getLogger(__name__)


# Verifies sending a follow-up on an open task completes on the same task URL.
def test_task_followup(page, go_to_task_page):
    ...
    go_to_task_page.enter_follow_up_task(task=FOLLOW_UP_ANDROID_ACTION)
